...
export default function SiteLegalSettingsPage() {
  ...
  return <div className="min-h-screen bg-background"><AdminHeader title="Dati legali e policy" subtitle="Informazioni pubblicate automaticamente nel sito" /><main className="mx-auto max-w-5xl space-y-6 p-6">
