...
values
  ...
  ('suite-commercial-policy','Core','Regola commerciale 4BID cross-sell centralizzata',true,true,'Stato ufficiale: Codice. Evidenza: PR #308 e #340. Il Core rappresenta la sorgente della policy; va verificata la lettura coerente in tutti i prodotti satellite e preventivatori.',28,'repo-sync',now()),
