...
export function CustomerLicenseBadge() {
  ...
  return (
    <div
      className="pointer-events-none fixed right-[17rem] top-2.5 z-20 hidden h-9 items-center rounded-md border border-border bg-background/95 px-2.5 shadow-sm xl:flex"
