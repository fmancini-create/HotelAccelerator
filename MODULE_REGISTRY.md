...
| Assistente vocale 3CX | Agenti telefonici dalle basi del singolo tenant e IVR 4 BID con due percorsi (supporto/prospect), codice cliente, risposta fondata, reperibilità/messaggio e coda supporto | Codice | Ogni tenant espone solo le proprie basi; il centralino aziendale aggiunge la directory centrale. Configurare il custom tool e collaudare ogni agente sul PBX prima di promuovere a Demo |
