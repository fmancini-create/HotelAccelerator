...
| AI inbox | Intenti, estrazione dati, riassunti, risposte, escalation, sentiment, upselling, knowledge base | Specifica | Associazione ordinata delle basi per account Email/WhatsApp/Telegram in stato `Codice`; restano da definire provider, valutazioni, privacy e human-in-the-loop dell'insieme del modulo |
