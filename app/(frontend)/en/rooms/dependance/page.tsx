...
export const metadata: Metadata = {
  ...
  description: "Greater privacy in an independent structure surrounded by the Chianti hills.",
  alternates: {
    canonical: "/en/rooms/dependance",
    languages: { it: "/camere/dependance", de: "/de/zimmer/dependance", fr: "/fr/chambres/dependance" },
  },
}

export default async function DependancePage() {
  const galleryImages = await getPhotosByCategory("dependance")
    ...
    <main className="min-h-screen bg-background">
      ...
      <section id="toppage" className="relative h-screen">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 pointer-events-none z-10">
          ...
          <h2 className="text-2xl md:text-3xl text-white/95 font-serif font-light">Your Private Retreat</h2>
        </div>
      ...
      <section id="content" className="py-20 bg-[#f5f3f0]">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          ...
          <h2 className="text-[#7a7a7a] text-xl md:text-2xl mb-10 font-serif">
            Maximum Privacy in an Independent Structure
          </h2>
          <a
          ...
          <div className="text-[#7a7a7a] text-base leading-relaxed space-y-4">
            <p>Our Dependance offers greater privacy in a completely independent structure.</p>
            <p>
              Perfect for those seeking a more intimate and reserved experience while still enjoying all the resort's
              services.
            </p>
          </div>
        </div>
