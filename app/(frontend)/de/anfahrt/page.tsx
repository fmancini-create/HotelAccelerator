...
export const metadata: Metadata = {
  title: "Anfahrt - Villa I Barronci Resort & Spa im Chianti",
  description:
    "Villa I Barronci befindet sich in San Casciano Val di Pesa, im Herzen des Chianti, 20 Minuten von Florenz entfernt. So erreichen Sie uns.",
  alternates: {
    canonical: "/de/anfahrt",
    languages: {
      it: "/dove-siamo",
      en: "/en/location",
      fr: "/fr/acces",
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] min-h-[500px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          <h1 className="text-4xl md:text-6xl font-serif text-white mb-4">Villa I Barronci, im Herzen des Chianti</h1>
          <p className="text-xl md:text-2xl text-white/90">So erreichen Sie uns</p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-8 max-w-6xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-muted-foreground mb-12 text-center">
          <p>
            Eingebettet in das magische und unberührte Gebiet des Chianti erhebt sich unser Resort majestätisch auf dem
            höchsten Hügel von San Casciano und bietet atemberaubende Ausblicke und eine bezaubernde Atmosphäre.
            Strategisch gelegen, ist es der ideale Ausgangspunkt, um die historischen und kulturellen Schätze der
            wichtigsten Zentren der Toskana zu erkunden und Ihnen ein unvergessliches Erlebnis in der zeitlosen
            Schönheit der Region zu bieten.
          </p>
        </div>
