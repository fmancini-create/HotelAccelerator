...
export const metadata: Metadata = {
  title: "Location - Villa I Barronci Resort & Spa in Chianti",
  description:
    "Villa I Barronci is located in San Casciano Val di Pesa, in the heart of Chianti, 20 minutes from Florence. How to reach us.",
  alternates: {
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] min-h-[500px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          <h1 className="text-4xl md:text-6xl font-serif text-white mb-4">Villa I Barronci, in the heart of Chianti</h1>
          <p className="text-xl md:text-2xl text-white/90">How to reach us</p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-8 max-w-6xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-muted-foreground mb-12 text-center">
          <p>
            Immersed in the magical and unspoiled territory of Chianti, our resort stands majestically on the highest
            hill of San Casciano, offering breathtaking views and an enchanting atmosphere. Strategically located, it is
            the ideal starting point to explore the historical and cultural treasures of the main centers of Tuscany,
            giving you an unforgettable experience immersed in the timeless beauty of the region.
          </p>
        </div>
