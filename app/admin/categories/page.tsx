...
import { ArrowLeft, Plus, Pencil, Trash2, FolderPlus, LogOut } from "lucide-react"
import { getCurrentUser, logout, type AdminUser } from "@/lib/admin-users"
    ...
    <div className="min-h-screen bg-[#f8f5f0]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-lg font-semibold text-[#2c2c2c]">Gestione Categorie</h1>
            </div>
            <div className="flex items-center gap-4">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <Button onClick={() => setIsAddDialogOpen(true)} className="bg-[#8a7355] hover:bg-[#6b5a43]">
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>Modifica le impostazioni della categoria "{selectedCategory?.label}"</DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="space-y-2">
              <Label>Nome categoria</Label>
            ...
            <div className="space-y-2">
              ...
              {!selectedCategory?.isCustom && (
                <p className="text-xs text-[#6b6b6b]">Lo slug delle categorie predefinite non può essere modificato</p>
              )}
            </div>
            <div className="space-y-2">
              <Label>Path cartella</Label>
