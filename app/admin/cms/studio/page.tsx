...
export default function CMSStudioPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {!speechSupported && <div className="rounded-lg border border-ha-warning/30 bg-ha-warning/5 p-3 text-sm text-ha-warning-soft-foreground">Per usare la voce prova Chrome o Edge aggiornato e consenti il microfono.</div>}
