...
insert into public.platform_product_roadmap (
  ...
  457,
  'Stato ufficiale: Codice su branch/PR #457, dipendente da Santaddeo PR #1170. Santaddeo resta owner dei connector PMS e HotelAccelerator consuma contratti API versionati tenant-scoped. Il browser PMS resta indipendente. La UI mostra solo dati e scritture realmente supportati; endpoint disponibili ma non ancora normalizzati sono distinti da capability pronte. Prima di Online: CI verde, merge main, deploy coordinato Santaddeo + Core e collaudo reale multi-tenant.',
  192,
  'repo-sync',
