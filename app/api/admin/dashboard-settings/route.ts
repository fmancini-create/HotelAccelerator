    ...
    const { error } = await sb.from("dashboard_user_settings").upsert(
      {
        ...
        closed_deals_target: goals.closedDealsTarget,
        closed_revenue_target_cents: goals.closedRevenueTargetCents,
        custom_goal_metric: goals.customGoalMetric,
        custom_goal_label: goals.customGoalLabel,
        custom_goal_target: goals.customGoalTarget,
        custom_goal_period: goals.customGoalPeriod,
