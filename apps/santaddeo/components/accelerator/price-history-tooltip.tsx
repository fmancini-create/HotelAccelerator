                      ...
                      <tbody>
                        ...
                        */}
                        ...
                        {displayPrice != null && (() => {
                          ...
                          // Quando il Last-minute e' attivo, qualsiasi scostamento tra displayPrice (LM
                          // a video) e prezzo persistito e' puramente visuale: non e' un invio pendente.
                          const lmVisualOnly = !!lastMinute?.active
                          ...
                          const alignedWithPms = lmVisualOnly || (sentPrice != null && Math.abs(pushedPrice - sentPrice) < 1)
